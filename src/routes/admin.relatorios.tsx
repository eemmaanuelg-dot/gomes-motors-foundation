    ...
    <Panel>
      ...
      <div className="mt-4 space-y-2">
        {rows.length ? rows.map((row) => (
          <div key={row.label} className="flex items-center justify-between border-b border-border/70 py-2.5 text-sm">
            <span>{row.label}</span>
